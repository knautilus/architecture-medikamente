...
| Медицинские данные  | Шифрование на уровне БД/файлов; ограниченный доступ по ролям/атрибутам | TLS 1.2+             | Деперсонализация для BI/ML                                  |
| Финансовые данные   | Шифрование БД 1С/файлов; журналирование операций                       | TLS 1.2+             | Маскирование чеков в отчетах, доступ только для бухгалтерии |
| Документы/сканы     | Объектное хранилище с шифрованием и версиями                           | TLS 1.2+             | Запрещён экспорт вне безопасной зоны                        |
| Логи/журналы        | Централизованное хранилище с шифрованием                               | TLS/mTLS             | Не записывать конфиденциальные данные в логи                |
...
- **Предотвращение утечки данных**: Symantec DLP
